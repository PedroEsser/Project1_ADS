...
<body>
	<div class="w3-top">
	  <div class="w3-bar w3-white w3-border w3-large">
	  	...
	  	<input id="vis" type="button" value="WebVOWL" onclick="window.location.href='https://webvowl.blackglacier-3bc0d68a.northeurope.azurecontainerapps.io/#iri=https://raw.githubusercontent.com/ADSDummyUser/Knowledge_Base/master/ontology.owl'" style="cursor: pointer;" class="w3-bar-item w3-hide-small w3-padding-large w3-white"/>
